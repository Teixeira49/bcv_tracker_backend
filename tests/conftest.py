...
os.environ.setdefault("MARKET_DATA_PROVIDER_E_URL", "http://testserver.local")
os.environ.setdefault("MARKET_DATA_PROVIDER_F_URL", "http://testserver.local")
os.environ.setdefault("MARKET_DATA_PROVIDER_G_URL", "http://testserver.local")
os.environ.setdefault("MARKET_DATA_PROVIDER_H_URL", "http://testserver.local")
